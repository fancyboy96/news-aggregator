        ...
        this.container.innerHTML = `
            <div class="relative">
                ...
                <div id="country-dropdown" class="hidden absolute z-50 mt-1 w-full bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-slate-100 dark:border-slate-700 max-h-80 flex flex-col">
                    <div class="p-2 border-b border-slate-100 dark:border-slate-700 sticky top-0 bg-white dark:bg-slate-800 rounded-t-lg space-y-2">
                        ...
                        <div class="flex gap-2">
                            <button type="button" id="select-all-countries" class="flex-1 text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 py-1.5 rounded transition-colors">Select All</button>
                            <button type="button" id="deselect-all-countries" class="flex-1 text-xs font-medium text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 py-1.5 rounded transition-colors">Select None</button>
                        </div>
                    </div>
